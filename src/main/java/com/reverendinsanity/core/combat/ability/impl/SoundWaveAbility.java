...
// 音波蛊技能：音波冲击——前方6格音波伤害+击退
public class SoundWaveAbility extends GuAbility {

    public SoundWaveAbility() {
        super(GuRegistry.id("sound_wave_gu"), 8f, 100, AbilityType.INSTANT);
    }
    ...
    protected void onActivate(ServerPlayer player, Aperture aperture) {
        ...
        player.level().playSound(null, player.getX(), player.getY(), player.getZ(),
            SoundEvents.WARDEN_SONIC_BOOM, SoundSource.PLAYERS, 0.6f, 1.5f);
    }
}
