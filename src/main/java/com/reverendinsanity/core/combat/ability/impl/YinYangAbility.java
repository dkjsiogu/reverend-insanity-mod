...
// 阴阳蛊技能：阴阳双击——前方8格阴阳双重打击
public class YinYangAbility extends GuAbility {

    public YinYangAbility() {
        super(GuRegistry.id("yin_yang_gu"), 10f, 120, AbilityType.INSTANT);
    }
    ...
    protected void onActivate(ServerPlayer player, Aperture aperture) {
        ...
        player.level().playSound(null, player.getX(), player.getY(), player.getZ(),
            SoundEvents.ENCHANTMENT_TABLE_USE, SoundSource.PLAYERS, 0.9f, 0.8f);
    }
}
