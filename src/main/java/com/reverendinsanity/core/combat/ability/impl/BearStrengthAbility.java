...
import com.reverendinsanity.core.combat.buff.impl.BearStrengthBuff;
...
public class BearStrengthAbility extends GuAbility {
    ...
    public BearStrengthAbility() {
        super(GuRegistry.id("bear_strength_gu"), 8f, 400, AbilityType.BUFF);
    }

    @Override
    protected void onActivate(ServerPlayer player, Aperture aperture) {
        GuMasterData data = player.getData(ModAttachments.GU_MASTER_DATA.get());
        data.getBuffManager().applyBuff(player, new BearStrengthBuff());
