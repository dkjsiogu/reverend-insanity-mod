...
// 信蛊技能：信道信息攻击
public class InfoDartAbility extends GuAbility {

    public InfoDartAbility() {
        super(GuRegistry.id("info_dart_gu"), 8f, 100, AbilityType.INSTANT);
    }

    @Override
    protected void onActivate(ServerPlayer player, Aperture aperture) {
        float efficiency = aperture.getEssenceGrade().getEfficiency();
        float pathBonus = 1.0f + aperture.getPathRealm(DaoPath.INFORMATION).getTier() * 0.15f;
